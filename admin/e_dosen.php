					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td> <i> <a href='UpdateDosen.php?ID_DOSEN=".$data['ID_DOSEN']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteDosen.php?ID_DOSEN=".$data['ID_DOSEN']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
