					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td> <i> <a href='UpdateRuangan.php?ID_RUANGAN=".$data['ID_RUANGAN']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteRuangan.php?ID_RUANGAN=".$data['ID_RUANGAN']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
