					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td>".$data['ID_DOSEN']."</td>
								<td> <i> <a href='UpdateMengajar.php?ID_MENGAJAR=".$data['ID_MENGAJAR']."&ID_MATKUL=".$data['ID_MATKUL']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteMengajar.php?ID_MENGAJAR=".$data['ID_MENGAJAR']."&ID_MATKUL=".$data['ID_MATKUL']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
