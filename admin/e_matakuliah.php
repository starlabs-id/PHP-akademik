					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td>".$data['SEMESTER']."</td>
								<td> <i> <a href='UpdateMataKuliah.php?ID_MATKUL=".$data['ID_MATKUL']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteMataKuliah.php?ID_MATKUL=".$data['ID_MATKUL']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
