...
$ID_MENGAJAR = mysql_real_escape_string($_GET['ID_MENGAJAR']);
$ID_MATKUL = mysql_real_escape_string($_GET['ID_MATKUL']);
$query = "SELECT * FROM mengajar where ID_MENGAJAR='$ID_MENGAJAR' AND ID_MATKUL='$ID_MATKUL'"; //get the data that will be updated
	...
	<div class="shell">
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
				<div class="box-head">
						<h2>Update Mengajar</h2>
					</div>
					<!-- End Box Head -->
					<br><br>
					<form name='Update' method = 'post' action='UpdateTabelMengajar.php'>
