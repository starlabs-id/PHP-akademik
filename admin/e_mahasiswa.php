		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Tabel Mahasiswa</h2>
					</div>
					<!-- End Box Head -->	
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							...
							echo "
								...
								<td>".$data['NAMA_MHS']."</td>
								<td>".$data['PASSWORD']."</td>
								<td> <i> <a href='UpdateMahasiswa.php?NIM_MHS=".$data['NIM_MHS']."' class='ico edit'> Update </a> </i></td>
								<td> <i> <a href='DeleteMahasiswa.php?NIM_MHS=".$data['NIM_MHS']."' onClick='return warning()' class='ico del'> Delete </a> </i></td>
								</tr>";
							}
							?>
						</table>
