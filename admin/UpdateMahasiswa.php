...
$query = "SELECT * FROM mahasiswa where NIM_MHS='$NIM_MHS'"; //get the data that will be updated
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box-head">
					...
					<!-- End Box Head -->
					<br><br>
					<form name='Update' method = 'post' action='UpdateTabelMahasiswa.php'>
						...
						<div class="form">
							...
							<tr>
										<td width="200px"><p align="left"><label>NAMA MAHASISWA : </label></p></td>
										<td><input name="NAMA_MHS" type="text" value="<?php echo $data['NAMA_MHS']?>" class="field size1" ></td>
									
							</tr>
							<tr>
										<td width="200px"><p align="left"><label>PASSWORD : </label></p></td>
										<td><input name="PASSWORD" type="password" value="<?php echo $data['PASSWORD']?>" class="field size1" ></td>
